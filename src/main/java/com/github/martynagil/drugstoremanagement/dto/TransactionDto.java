...
public class TransactionDto {
	...
	public TransactionDto(Long id, LocalDateTime submissionTime, Long shopId, List<TransactionEntryDto> transactionEntries) {
		this.id = id;
	...
	public TransactionDto(
			...
			@JsonProperty("transactionEntries") List<TransactionEntryDto> transactionEntries) {
		this.submissionTime = submissionTime;
		this.shopId = shopId;
		this.transactionEntries = transactionEntries;
	}
	...
	public List<TransactionEntryDto> getTransactionEntries() {
